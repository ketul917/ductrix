...
def get_args():
    ...
    parser.add_argument('-n', '--new_vm',
                        required=False,
                        action='store',
                        default=None,
                        help='Name of the Newly created app')
...
#        exit(1)
    ...
    spec_params = vim.OvfManager.CreateImportSpecParams(entityName=args.new_vm, diskProvisioning="thin")
